          ...
          <div className="flex-1 flex items-center justify-center px-6 py-12">
            <div className="w-full max-w-2xl">
              ...
              {currentPage === 1 && (
                <form
                  id="auth-form"
                  onSubmit={(e) => { e.preventDefault(); setCurrentPage(2); }}
              ...
              {currentPage === 2 && (
                <form
                  id="auth-form"
                  onSubmit={(e) => { e.preventDefault(); setCurrentPage(3); }}
                  className="space-y-4 animate-fade-in"
                >
                  <div>
                    <label
              ...
              {currentPage === 4 && (
                <form
                  id="auth-form"
                  onSubmit={(e) => { e.preventDefault(); setCurrentPage(5); setStartTimer(true); }}
                  className="space-y-4 animate-fade-in"
                >
